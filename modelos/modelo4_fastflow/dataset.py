"""
Dataset para FastFlow que carga imágenes normales y defectuosas.
Usa el preprocesamiento común de 3 canales.
"""
...
class MDPDataset(Dataset):
    ...
    - Estructura 1: DATASET_PATH/train/normal/ y DATASET_PATH/valid/normal/ y defectuoso/
    - Estructura 2: DATASET_PATH/0/, DATASET_PATH/1/, ... (carpetas numéricas)
    """
    ...
    def __init__(
        self,
        data_dir: Path,
        split: str = 'train',  # 'train' o 'valid' o 'test'
        class_name: Optional[str] = None,  # 'normal' o 'defectuoso' o None (ambos)
        img_size: int = 256,
        ...
        Args:
            ...
            class_name: 'normal', 'defectuoso' o None (cargar ambos)
        ...
        self.labels: List[int] = []  # 0 = normal, 1 = defectuoso
